...
%define secureboot_ca %{_datadir}/pki/sb-certs/secureboot-ca-%{_arch}.cer
%define secureboot_key %{_datadir}/pki/sb-certs/secureboot-fwupd-%{_arch}.cer
Patch90000:           90000-Adding-Rocky-data-to-generate_sbat-for-branding.patch
...
%pesign -s -i %{fwup_efi_fn} -o %{fwup_efi_fn}.signed -a %{secureboot_ca} -c %{secureboot_key} -n rockybootsigningcert
%endif
...
%changelog
* Wed Nov 15 2023 Release Engineering <releng@rockylinux.org> - 1.7.8-2.rocky.0.1
